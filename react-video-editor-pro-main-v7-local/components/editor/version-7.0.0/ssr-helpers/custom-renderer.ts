    ...
    try {
      ...
      await renderMedia({
        ...
        chromiumOptions: {
          ...
          ignoreCertificateErrors: true, // Ignore SSL certificate errors
        },
        ...
        // Balanced quality settings for better performance
        crf: 23, // Balanced quality (range 1-51, where 23 is a good default)
        imageFormat: "jpeg", // Use JPEG for better performance
        colorSpace: "bt709", // Better color accuracy
        x264Preset: "medium", // Balanced compression
        jpegQuality: 80, // Good quality JPEG
      });
